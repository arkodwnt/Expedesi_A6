...
<html lang="en">
  <head>
    ...
    <title>Logis Bootstrap Template - Penerima</title>
  ...
  <body>
    ...
    <main id="main">
      ...
      <table style="width:80%">
        ...
        $hasil = mysqli_query($koneksi, "SELECT * FROM tbl_penerima")
        ?>
        <?php
        $no = 1;
        while ($data = mysqli_fetch_array($hasil)) {
          ...
          echo "<td>
            <a href='editpenerima.php?id_penerima=$data[id_penerima]' class='btn btn-warning btn-sm' style='font-weight: 600;'>Edit</a>|
            <a href='deletepenerima.php?id_penerima=$data[id_penerima] ' class='btn btn-danger btn-sm' style='font-weight: 600;'>Delete</a>
            </td>";
          echo "</tr>";
          $no++;
        }
      ...
      <br>
      <a href='createpenerima.php' class='btn btn-primary btn-lg' style='font-weight: 600;'>Tambah</a>
      <h1> </h1>
