...
<html lang="en">
  <head>
    ...
    <title>Logis Bootstrap Template - Pengirim</title>
  ...
  <body>
    ...
    <main id="main">
      ...
      <table style="width:80%">
        ...
        $hasil = mysqli_query($koneksi, "SELECT * FROM tbl_pengirim")
        ?>
        <?php
        $no = 1;
        while ($data = mysqli_fetch_array($hasil)) {
          ...
          echo "<td>
            <a href='editpengirim.php?id_pengirim=$data[id_pengirim]' class='btn btn-warning btn-sm' style='font-weight: 600;'>Edit</a>|
            <a href='deletepengirim.php?id_pengirim=$data[id_pengirim] ' class='btn btn-danger btn-sm' style='font-weight: 600;'>Delete</a>
            </td>";
          echo "</tr>";
          $no++;
        }
      ...
      <br>
      <a href='createpengirim.php' class='btn btn-primary btn-lg' style='font-weight: 600;'>Tambah</a>
      <h1> </h1>
