  ...
  <body>
    ...
    <main id="main">
      ...
      <div class="breadcrumbs">
        <div class="page-header d-flex align-items-center" style="background-image: url('assets/img/barang.jpeg')">
      ...
      <table style="width:80%">
        ...
        while ($data = mysqli_fetch_array($hasil)) {
          ...
          echo "<td>
            <a href='editbarang.php?id_barang=$data[id_barang]' class='btn btn-warning btn-sm' style='font-weight: 600;'>Edit</a>|
            <a href='deletebarang.php?id_barang=$data[id_barang] ' class='btn btn-danger btn-sm' style='font-weight: 600;'>Delete</a>
            </td>";
          echo "</tr>";
          $no++;
        }
      ...
      <br>
      <a href='createbarang.php' class='btn btn-primary btn-lg' style='font-weight: 600;'>Tambah</a>
      <h1> </h1>
