  ...
  <body>
    ...
    <main id="main">
      ...
      <table style="width:80%">
        ...
        $hasil = mysqli_query($koneksi, "SELECT * FROM tbl_gudang")
        ?>
        <?php
        $no = 1;
        while ($data = mysqli_fetch_array($hasil)) {
          ...
          echo "<td>
            <a href='editgudang.php?id_gudang=$data[id_gudang]' class='btn btn-warning btn-sm' style='font-weight: 600;'>Edit</a>|
            <a href='deletegudang.php?id_gudang=$data[id_gudang] ' class='btn btn-danger btn-sm' style='font-weight: 600;'>Delete</a>
            </td>";
          echo "</tr>";
          $no++;
        }
      ...
      <br>
      <a href='creategudang.php' class='btn btn-primary btn-lg' style='font-weight: 600;'>Tambah</a>
      <h1> </h1>
